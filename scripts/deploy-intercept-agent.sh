#!/usr/bin/env bash
# =============================================================================
# Deploy Intercept Agent to AgentCore Runtime
# Creates or updates an AgentCore Runtime with the ECR image, waits for READY.
#
# Usage:
#   ./scripts/deploy-intercept-agent.sh [AWS_ACCOUNT_ID] [AWS_REGION]
#
...
IMAGE_URI="${ECR_REGISTRY}/intercept-agent:latest"
RUNTIME_NAME="intercept-agent-runtime"
MAX_WAIT_SECONDS=300
POLL_INTERVAL=10

echo "=== Deploy Intercept Agent ==="
